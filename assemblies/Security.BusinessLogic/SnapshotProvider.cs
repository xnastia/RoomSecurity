...
namespace Security.BusinessLogic
{
    ...
    {
        private static readonly Dictionary<Monitor, MonitorSnapshot> MonitorSnapshot = new Dictionary<Monitor, MonitorSnapshot>();
        ...
        private static MonitorSnapshot CreateMonitorSnapshot(Monitor monitor)
        {
            ...
            monitor.EventOnCheckDone += alarmStatusProvider.InsertCheckerResponseIntoAlarmStatus;
